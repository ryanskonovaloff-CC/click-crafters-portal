...
function normalizeAdLifetimePerformance(row: Record<string, unknown>): AdLifetimePerformance {
  ...
  return {
    ...
    status: row.status ? String(row.status) : row.ad_status ? String(row.ad_status) : null,
    headline: row.headline ? String(row.headline) : row.creative_headline ? String(row.creative_headline) : null,
    headline_2: row.headline_2 ? String(row.headline_2) : null,
    headline_3: row.headline_3 ? String(row.headline_3) : null,
    description: row.description ? String(row.description) : row.creative_description ? String(row.creative_description) : null,
    ...
    image_url: row.image_url ? String(row.image_url) : row.creative_image_url ? String(row.creative_image_url) : null,
    thumbnail_url: row.thumbnail_url ? String(row.thumbnail_url) : row.creative_image_url ? String(row.creative_image_url) : null,
