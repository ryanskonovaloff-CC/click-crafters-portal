    ...
    return (
      <main className="relative z-10 grid min-h-screen place-items-center px-4 py-10">
        <section className="w-full max-w-md rounded-2xl border border-border bg-black/40 p-6 shadow-glow backdrop-blur">
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-normal">Session <AccentText>Expired</AccentText></h1>
          <p className="mt-3 text-sm leading-6 text-white/60">
            You were signed out after more than 24 hours away from the portal.
          </p>
          <div className="mt-5 rounded-xl border border-accent/30 bg-accent/10 px-4 py-3 text-sm leading-5 text-orange-100/85">
            This keeps client reporting and account data protected when a browser is left open.
          </div>
          <Link href="/login" className="mt-6 inline-flex w-full items-center justify-center rounded-xl bg-accent px-4 py-3 font-semibold text-black hover:bg-orange-400">
            Back to login
          </Link>
        </section>
      </main>
