...
import { PlatformBreakdown, PlatformCpaChart, PlatformRoasChart, TrendChart } from "@/components/charts";
  ...
  return (
    <div className="mx-auto min-w-0 max-w-7xl space-y-4 sm:space-y-6">
      ...
      <div className="grid gap-3 sm:gap-4 xl:grid-cols-2">
        ...
        <Card><h2 className="mb-3 text-base font-semibold sm:mb-4 sm:text-lg"><AccentText>ROAS</AccentText> over time</h2>{hasData ? <PlatformRoasChart data={daily} previousData={previousDaily} compare={compare} /> : <EmptyState />}</Card>
