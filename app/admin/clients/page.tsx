      ...
      <Card>
        <Table headers={["Client", "Slug", "Industry", "Status", "Last updated", ""]} rows={clients.map((client: any) => [
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-lg border border-accent/45 bg-accent/10 px-3 py-2 text-xs font-medium text-accent transition hover:border-accent hover:bg-accent/15"
          >
            View account
          </Link>
        ])} />
